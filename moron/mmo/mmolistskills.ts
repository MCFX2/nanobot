...
export class WoodchopSkill extends BaseSkill {
	public constructor() {
		...
		this.skillMaxedMessage =
			"There are no trees left for you to cut. You've chopped them all down. I hope you're happy.";
		this.ranks = [
...
export class FishingSkill extends BaseSkill {
	public constructor() {
		...
		this.skillMaxedMessage =
			"You're a master of the seas already, captain. Shouldn't you get back to your family?";
		this.ranks = [
...
export class ForagingSkill extends BaseSkill {
	public constructor() {
		...
		this.skillMaxedMessage =
			"You are so good at foraging that you have found all the food in the world. You should probably stop now.";
		this.ranks = [
			"Three-ager", // 1
...
export class CombatSkill extends BaseSkill {
	public constructor() {
		...
		this.skillMaxedMessage =
			"There is nobody left. You killed everyone. You can't kill anymore. You're done.";
		this.ranks = [
			"Weakling", // 1
			"Wimp",
			"Punching Bag",
...
export class MiningSkill extends BaseSkill {
	public constructor() {
		...
		this.skillMaxedMessage =
			"The earth is hollow. It has nothing more to give you. You've taken it all.";
		this.ranks = [
			"Unlikely Denizen", // 1
			"Rock Hound",
			"Coal Carrier",
